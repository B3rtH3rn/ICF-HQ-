 ...
 * for every user. ONLY color, energy, and accent symbols are customizable.
 * There is deliberately NO body-shape, body-size, or facial customization —
 * this app serves teens in a mental-health context and body-shape
 * customization risks becoming a body-image trigger. Do not add body/face
 * options here without explicit sign-off.
 */
...
export const SYMBOL_OPTIONS = [
  ...
  { id: "mountain", char: "⛰️", label: "Mountains" },
  { id: "book", char: "📖", label: "Books" },
  { id: "dog", char: "🐕", label: "Dogs" },
  { id: "camera", char: "📷", label: "Photography" },
  { id: "art", char: "🎨", label: "Art" },
  { id: "moon", char: "🌙", label: "Moon" },
  { id: "soccer", char: "⚽", label: "Soccer" },
  { id: "tennis", char: "🎾", label: "Tennis" },
];

/** The single, fixed full-body outline path (viewBox 0 0 200 380). */
